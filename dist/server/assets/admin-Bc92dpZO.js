import { a as adminListUsers, i as adminListAuditLogs, n as adminBulkImportPrices, o as adminTriggerSMSAlerts, r as adminChangeUserRole } from "./admin-BB9FwSaB.js";
		...
		children: [/* @__PURE__ */ jsxs(CardHeader, {
			...
			children: /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					}) }), /* @__PURE__ */ jsx("tbody", { children: (userData?.users ?? []).map((u) => {
		...
		children: [/* @__PURE__ */ jsxs(CardHeader, {
			...
			children: /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					}) }), /* @__PURE__ */ jsx("tbody", { children: (data?.logs ?? []).map((l) => {
					...
					children: [/* @__PURE__ */ jsx(Label, {
						...
						children: [/* @__PURE__ */ jsx("input", {
							...
							children: [/* @__PURE__ */ jsx(Upload, { className: "h-8 w-8 mx-auto text-muted-foreground group-hover:text-primary transition-colors" }), /* @__PURE__ */ jsx("p", {
								...
								children: "Drag and drop or click to upload .csv"
							})]
						})]
					})]
...
function SmsBroadcastTab() {
	...
	const broadcastMutation = useMutation({
		...
		onSuccess: (res) => {
			setTriggering(false);
			setBroadcastLog((prev) => [`[${(/* @__PURE__ */ new Date()).toLocaleTimeString()}] Broadcast successful! Dispatched updates to ${res.count} active subscriber(s).`, ...prev]);
