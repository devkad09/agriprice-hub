...
import { a as listMarkets, i as listCommodities, n as deletePrice, o as updatePrice, r as getPrices, t as addPrice } from "./backend-prices-CbhrBvjN.js";
...
import { ClipboardPenLine, History, Loader2, Pencil, Plus, ShieldAlert, Trash2 } from "lucide-react";
...
function OfficerPage() {
	...
	if (!user || !canEditPrices) return /* @__PURE__ */ jsx(AppLayout, { children: /* @__PURE__ */ jsx("main", {
...
function PriceEntryForm() {
	...
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsxs(CardHeader, { children: [/* @__PURE__ */ jsxs(CardTitle, {
			...
			children: [/* @__PURE__ */ jsx(ClipboardPenLine, { className: "h-5 w-5 text-primary shrink-0" }), "Record Daily Price"]
...
function RecentEntriesTable() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		/* @__PURE__ */ jsxs(Card, {
			...
			children: [/* @__PURE__ */ jsxs(CardHeader, { children: [/* @__PURE__ */ jsxs(CardTitle, {
				className: "font-display text-lg flex items-center gap-2",
				children: [/* @__PURE__ */ jsx(History, { className: "h-5 w-5 text-primary shrink-0" }), "Your Recent Price Entries"]
