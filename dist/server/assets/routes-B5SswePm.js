import { n as marketsQuery, t as commoditiesQuery } from "./routes-CuV4hfC5.js";
		...
		children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 -z-10 hero-background-image" }), /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									className: "font-display text-base font-bold text-foreground block leading-tight",
									children: "5"
								}), /* @__PURE__ */ jsx("span", {
									className: "text-xs",
									children: "markets"
							...
							/* @__PURE__ */ jsx("div", { className: "h-8 w-px bg-border hidden sm:block" }),
							/* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-2",
								children: [/* @__PURE__ */ jsx("span", {
									className: "grid h-9 w-9 place-items-center rounded-lg bg-primary/10 text-primary",
									children: /* @__PURE__ */ jsx(Sprout, { className: "h-4.5 w-4.5" })
								}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("span", {
									className: "font-display text-base font-bold text-foreground block leading-tight",
									children: "20"
								}), /* @__PURE__ */ jsx("span", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", {
									className: "grid h-9 w-9 place-items-center rounded-lg bg-primary/10 text-primary",
									children: /* @__PURE__ */ jsx(Smartphone, { className: "h-4.5 w-4.5" })
								}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("span", {
									className: "font-display text-base font-bold text-foreground block leading-tight",
									children: "SMS"
								}), /* @__PURE__ */ jsx("span", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						className: "w-full max-w-[380px] rounded-2xl border border-border bg-card/90 backdrop-blur-md p-6 shadow-2xl",
						children: [
							/* @__PURE__ */ jsxs("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
						...
						children: "AgriFarm puts real-time market information in every farmer's hand — from the smallholder in Bolgatanga to traders in Accra's busiest hubs."
					})] }), /* @__PURE__ */ jsx("div", {
						className: "mt-8 hidden lg:block overflow-hidden rounded-2xl border border-border/60 bg-muted aspect-[3/2] shadow-[var(--shadow-card)]",
