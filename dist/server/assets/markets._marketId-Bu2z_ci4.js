...
import { t as Route } from "./markets._marketId-WlxJFP1_.js";
...
function MarketContent() {
	...
	const locationInfo = market.location_lat != null && market.location_lng != null ? `${Number(market.location_lat).toFixed(3)}, ${Number(market.location_lng).toFixed(3)}` : null;
