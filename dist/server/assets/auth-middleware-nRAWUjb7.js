import { g as getRequest } from "./esm-9EjmF9OT.js";
...
var requireSupabaseAuth = createMiddleware({ type: "function" }).server(async ({ next }) => {
	...
	const isDefaultOrMock = !SUPABASE_URL || SUPABASE_URL.includes("your-project") || SUPABASE_URL.includes("fbrcnxwypiccqazgyxbz") || process.env.VITE_USE_MOCK_SUPABASE === "true";
