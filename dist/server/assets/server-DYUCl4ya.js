...
import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-Clp-zytd.js";
import "react";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CMBVYqlK.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-MsfGCuiV.js"),
		import("./start-ClPRZbGC.js"),
